...
public class UsuarioDao {
    ...
    public BeansUsuario buscarPorId(BeansUsuario mod){
        conex.conexao();
     ...
     public BeansUsuario buscarPorNome(BeansUsuario mod){
        conex.conexao();
        conex.executaSql("SELECT * FROM usuario WHERE nome = '" + mod.getPesquisarPorNome() + "'");
